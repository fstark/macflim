...
**Current code** ([src/compressor_helper.cpp L48–L66](../src/compressor_helper.cpp#L48)):
...
Refactor `compressor_helper::add()` to call `encode_frame()` internally — zero behavior change, existing tests still pass.
