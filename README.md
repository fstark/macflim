...
Please do not barf on code quality this is was not in releasable state, but people want to use it. You may even be one of those people. Hi!
...
* youtube-dl => (optional) retreive youtune sample movie
...
## Get the source media (youtub example)
...
## Generating an mp4 identical to the move
