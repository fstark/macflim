...
namespace macflim
{
    ...
    public:
        ...
        {
            return byte_ruler_.distance(x >> 24, y >> 24) + byte_ruler_.distance((x >> 16) & 0xff, (y >> 16) & 0xff) + byte_ruler_.distance((x >> 8) & 0xff, (y >> 8) & 0xff) + byte_ruler_.distance(x & 0xff, y & 0xff);
        }
