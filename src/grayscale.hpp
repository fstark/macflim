...
namespace macflim
{
    ...
    public:
        ...
        {
            std::transform(y, y + W_ * H_, std::begin(grayscale_), [](auto v)
                           { return v / 255.0; });
        }
    };
    ...
    void error_diffusion(grayscale &dest, const grayscale &source, const grayscale &previous, float stability, const dither_algorithm &algo, float bleed = 1, bool two_ways = false);
