...
## 2. Remove stray debug `printf`s from production paths
...
## 3. Extract argument parsing from the ~500-line `main()`
...
## 4. Replace `system()` calls with safer alternatives
...
## 5. Replace hard-coded magic numbers with named constants
