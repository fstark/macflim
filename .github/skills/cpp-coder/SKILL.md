...
When you refactor, you keep correct comments as they are (you can fix grammatical errors, of course), in particular you preserve inline step-comments. You add them when a block of code does something non-obvious. Those breadcrumbs are valuable for humans reading the code, even when the intent seems clear from variable names alone.
